        ...
        return (
            <div className="flex flex-row gap-4 py-6">
                ...
                <div className="bg-base-100 rounded-lg p-2">
                    <h4 className="font-bold">Tasks Progress</h4>
                ...
                <div className="space-y-2">
                    {tasks.map((task, index) => (
                        <div key={index} className="flex items-center">
                            <div className="font-semibold w-28 mr-2">{task.name}</div>
            ...
            <div className="bg-base-200 overflow-y-auto">
                ...
                >
                    ...
                    <div className="grid grid-cols-4 gap-4 py-4">
                        ...
                        <div className="card card-compact bg-base-100 shadow-xl backdrop-filter backdrop-blur-lg bg-opacity-10 hover:bg-opacity-70 transition duration-150 ease-in-out" onMouseEnter={() => handleHover('projects')} onMouseLeave={() => handleHover('')}>
                        ...
                        <div className="card card-compact bg-base-100 shadow-xl backdrop-filter backdrop-blur-lg bg-opacity-10 hover:bg-opacity-70 transition duration-150 ease-in-out" onMouseEnter={() => handleHover('tasks')} onMouseLeave={() => handleHover('')}>
                        ...
                        <div className="card card-compact bg-base-100 shadow-xl backdrop-filter backdrop-blur-lg bg-opacity-10 hover:bg-opacity-70 transition duration-150 ease-in-out" onMouseEnter={() => handleHover('dashboard')} onMouseLeave={() => handleHover('')}>
                            <div className="card-body flex items-start">
                                <figure className="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="card card-compact bg-base-100 shadow-xl backdrop-filter backdrop-blur-lg bg-opacity-10 hover:bg-opacity-70 transition duration-150 ease-in-out" onMouseEnter={() => handleHover('ganttChart')} onMouseLeave={() => handleHover('')}>
                            <div className="card-body flex items-start">
                                <figure className="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
